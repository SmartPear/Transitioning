...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Transitioning",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC13Transitioning13PushAnimation")
...
@interface PushAnimation (SWIFT_EXTENSION(Transitioning)) <UINavigationControllerDelegate>
...
@interface PushAnimation (SWIFT_EXTENSION(Transitioning)) <UIViewControllerAnimatedTransitioning>
...
@interface UIViewController (SWIFT_EXTENSION(Transitioning))
@property (nonatomic, strong) UIColor * _Nonnull barTintColor;
@property (nonatomic, copy) NSDictionary<NSAttributedStringKey, id> * _Nonnull titleTextAttributes;
